...
# Load model
model = tf.keras.models.load_model('models/densenet121_osteoarthritis_intensive_models/models/densenet121_osteoarthritis_intensive_20251006_185456.h5')
...
- **Accuracy Level**: Excellent (94.25%)
